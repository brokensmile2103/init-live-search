...
function init_plugin_suite_live_search_dict_ecommerce() {
    return [
        ...
        // Additional e-commerce terms
        'brand' => ['label', 'trademark', 'maker', 'thương hiệu', 'nhãn hiệu', 'hãng'],
        'category' => ['type', 'section', 'classification', 'danh mục', 'phân loại', 'loại'],
        'size' => ['dimension', 'fit', 'measurement', 'kích cỡ', 'size', 'cỡ'],
        'color' => ['colour', 'shade', 'tone', 'màu', 'màu sắc', 'màu sắc'],
        'quantity' => ['amount', 'number', 'count', 'số lượng', 'số lượng hàng'],
        'availability' => ['in stock', 'stock status', 'còn hàng', 'tình trạng hàng'],
        'out of stock' => ['sold out', 'unavailable', 'hết hàng', 'sold out'],
        'preorder' => ['pre-order', 'advance order', 'đặt trước', 'pre order'],
        'combo' => ['bundle', 'package deal', 'set', 'combo', 'trọn bộ', 'set giá'],
        'gift' => ['present', 'freebie', 'quà tặng', 'quà', 'tặng kèm'],
        'membership' => ['loyalty', 'vip', 'subscription', 'thành viên', 'hội viên'],
        'points' => ['reward points', 'loyalty points', 'điểm thưởng', 'tích điểm'],
        'warranty' => ['guarantee', 'assurance', 'bảo hành', 'bảo đảm'],
        'exchange' => ['swap', 'replace', 'trade', 'đổi hàng', 'đổi trả'],
        'tracking' => ['track order', 'shipment status', 'theo dõi đơn hàng', 'mã vận đơn'],
        'checkout' => ['pay now', 'complete order', 'thanh toán đơn hàng', 'hoàn tất đơn'],
        'installment' => ['pay later', 'trả góp', 'mua trước trả sau'],
        'wholesale' => ['bulk order', 'bán sỉ', 'bán buôn', 'sỉ'],
        'retail' => ['bán lẻ', 'lẻ', 'giá lẻ'],
        'marketplace' => ['sàn thương mại điện tử', 'sàn tmđt', 'nền tảng bán hàng'],
        'livestream' => ['live selling', 'bán hàng trực tiếp', 'phiên live'],
        'affiliate' => ['tiếp thị liên kết', 'affiliate marketing', 'cộng tác viên'],
        'dropship' => ['dropshipping', 'ký gửi', 'bán hàng không kho'],
    ];
}
...
function init_plugin_suite_live_search_dict_technology() {
    return [
        ...
        'browser' => ['web browser', 'chrome', 'firefox', 'trình duyệt', 'trình duyệt web'],
        'password' => ['passcode', 'login credential', 'mật khẩu', 'mã pin'],
        'account' => ['profile', 'login', 'tài khoản', 'profile'],
        'login' => ['sign in', 'log in', 'đăng nhập'],
        'logout' => ['sign out', 'log out', 'đăng xuất'],
        'notification' => ['alert', 'reminder', 'ping', 'thông báo', 'nhắc nhở'],
        'settings' => ['configuration', 'preferences', 'options', 'cài đặt', 'thiết lập', 'tùy chọn'],
        'file' => ['document', 'attachment', 'data', 'tệp', 'tập tin', 'file'],
        'folder' => ['directory', 'thư mục', 'folder'],
        'storage' => ['space', 'memory', 'capacity', 'bộ nhớ', 'dung lượng', 'lưu trữ'],
        'ram' => ['memory', 'bộ nhớ ram', 'ram'],
        'cpu' => ['processor', 'chip', 'vi xử lý', 'chip xử lý'],
        'gpu' => ['graphics card', 'card đồ họa', 'vga'],
        'battery' => ['power', 'charge', 'pin', 'nguồn'],
        'charger' => ['charging cable', 'adapter', 'sạc', 'cục sạc'],
        'screen' => ['display', 'monitor', 'màn hình', 'màn'],
        'camera' => ['cam', 'lens', 'máy ảnh', 'camera'],
        'keyboard' => ['keys', 'bàn phím', 'phím'],
        'router' => ['modem', 'access point', 'bộ phát wifi', 'router'],
        'firmware' => ['system software', 'firmware', 'phần mềm hệ thống'],
        'reset' => ['restart', 'reboot', 'factory reset', 'khôi phục', 'đặt lại', 'reset'],
        'crash' => ['freeze', 'error', 'treo máy', 'đơ máy', 'sập'],
        'lag' => ['slow', 'delay', 'giật lag', 'chậm', 'lag'],
        'automation' => ['tự động hóa', 'automated', 'tự động'],
        'chatbot' => ['bot', 'virtual assistant', 'trợ lý ảo', 'chatbot'],
        'saas' => ['software as a service', 'phần mềm dạng dịch vụ'],
        'api key' => ['access token', 'khóa api', 'mã api'],
    ];
}
...
function init_plugin_suite_live_search_dict_business() {
    return [
        ...
        'partner' => ['associate', 'collaborator', 'ally', 'đối tác', 'cộng sự'],
        'stakeholder' => ['shareholder', 'investor party', 'bên liên quan', 'cổ đông'],
        'ceo' => ['chief executive', 'giám đốc điều hành', 'tổng giám đốc'],
        'hr' => ['human resources', 'nhân sự', 'phòng nhân sự'],
        'recruitment' => ['hiring', 'staffing', 'tuyển dụng', 'tuyển người'],
        'onboarding' => ['orientation', 'induction', 'đào tạo hội nhập', 'onboarding'],
        'salary' => ['wage', 'pay', 'compensation', 'lương', 'tiền lương', 'thu nhập'],
        'bonus' => ['incentive', 'reward', 'thưởng', 'tiền thưởng'],
        'kpi' => ['key performance indicator', 'chỉ số hiệu suất', 'chỉ tiêu'],
        'roi' => ['return on investment', 'tỷ suất lợi nhuận', 'hiệu quả đầu tư'],
        'branding' => ['brand building', 'xây dựng thương hiệu', 'định vị thương hiệu'],
        'campaign' => ['promotion drive', 'chiến dịch', 'chương trình'],
        'audience' => ['target market', 'viewers', 'đối tượng', 'khán giả', 'tệp khách hàng'],
        'competitor' => ['rival', 'competition', 'đối thủ', 'đối thủ cạnh tranh'],
        'supplier' => ['vendor', 'provider', 'nhà cung cấp', 'nhà phân phối'],
        'logistics' => ['supply chain', 'distribution', 'hậu cần', 'chuỗi cung ứng'],
        'outsourcing' => ['subcontracting', 'thuê ngoài', 'gia công'],
        'freelance' => ['freelancer', 'independent contractor', 'làm tự do', 'freelancer'],
        'remote work' => ['work from home', 'wfh', 'làm việc từ xa'],
        'merger' => ['acquisition', 'consolidation', 'sáp nhập', 'mua lại'],
        'ipo' => ['initial public offering', 'niêm yết', 'phát hành cổ phiếu'],
        'tax' => ['taxation', 'levy', 'thuế', 'thuế má'],
        'audit' => ['inspection', 'review', 'kiểm toán', 'thanh tra'],
    ];
}
...
function init_plugin_suite_live_search_dict_health() {
    return [
        ...
        'nurse' => ['medical staff', 'caregiver', 'y tá', 'điều dưỡng'],
        'pharmacy' => ['drugstore', 'chemist', 'nhà thuốc', 'hiệu thuốc'],
        'prescription' => ['medical order', 'don thuoc', 'đơn thuốc', 'toa thuốc'],
        'insurance' => ['coverage', 'health plan', 'bảo hiểm', 'bảo hiểm y tế'],
        'emergency' => ['urgent care', 'crisis', 'cấp cứu', 'khẩn cấp'],
        'allergy' => ['allergic reaction', 'sensitivity', 'dị ứng'],
        'vaccine' => ['vaccination', 'immunization', 'vắc xin', 'tiêm chủng', 'tiêm phòng'],
        'blood pressure' => ['huyết áp', 'bp', 'áp huyết'],
        'diabetes' => ['tiểu đường', 'đái tháo đường'],
        'pregnancy' => ['pregnant', 'expecting', 'mang thai', 'thai kỳ', 'bầu'],
        'nutrition' => ['nutrients', 'dinh dưỡng', 'chất dinh dưỡng'],
        'protein' => ['đạm', 'chất đạm', 'protein'],
        'calorie' => ['calories', 'energy', 'calo', 'năng lượng'],
        'muscle' => ['cơ bắp', 'cơ', 'sức cơ'],
        'immune system' => ['immunity', 'hệ miễn dịch', 'sức đề kháng'],
        'mental health' => ['sức khỏe tinh thần', 'tâm lý', 'sức khỏe tâm thần'],
        'depression' => ['trầm cảm', 'buồn bã kéo dài'],
        'anxiety' => ['lo âu', 'lo lắng', 'căng thẳng thần kinh'],
        'physical therapy' => ['vật lý trị liệu', 'phục hồi chức năng'],
        'dental' => ['nha khoa', 'răng miệng', 'nha sĩ'],
        'eye care' => ['nhãn khoa', 'chăm sóc mắt', 'khám mắt'],
        'skincare' => ['chăm sóc da', 'dưỡng da'],
        'supplement' => ['thực phẩm chức năng', 'tpcn', 'bổ sung dinh dưỡng'],
    ];
}
...
function init_plugin_suite_live_search_dict_travel() {
    return [
        ...
        'visa' => ['permit', 'authorization', 'entry document', 'entry permit', 'travel visa', 'visa', 'thị thực', 'giấy phép'],
...
function init_plugin_suite_live_search_dict_sports() {
    return [
        ...
        'gym' => ['fitness center', 'health club', 'workout facility', 'phòng gym', 'phòng tập', 'trung tâm thể dục'],
...
function init_plugin_suite_live_search_dict_fashion() {
    return [
        ...
        'vintage' => ['retro', 'classic', 'classic style', 'old-style', 'vintage', 'cổ điển'],
